...
#     reviews = []
#     review_elements = soup.find_all('div', class_='_3gijNv')

#     for review_element in review_elements:
#         rating = review_element.find('div', class_='_3LWZlK').text.strip()
#         comment = review_element.find('div', class_='t-ZTKy').text.strip()
...
#         name = review_element.find('p', class_='_2sc7ZR').text.strip()
#         rating = review_element.find('div', class_='_3LWZlK').text.strip()
#         title = review_element.find('p', class_='_2-N8zT').text.strip()
#         comment = review_element.find('div', class_='t-ZTKy').text.strip()
...
#         fieldnames = ['Name', 'Rating', 'Title', 'Comment']
